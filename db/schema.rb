...
ActiveRecord::Schema.define(version: 20170808032453) do
  ...
  create_table "mercado_pago_purchases", force: :cascade do |t|
    ...
    t.integer  "checkout_list_id", limit: 4,                       null: false
  ...
  add_index "mercado_pago_purchases", ["checkout_list_id"], name: "index_mercado_pago_purchases_on_checkout_list_id", using: :btree
  ...
  create_table "product_rows", force: :cascade do |t|
    ...
    t.datetime "updated_at",                               null: false
    t.integer  "product_id",         limit: 4
    t.integer  "favourites_list_id", limit: 4
    t.integer  "checkout_list_id",   limit: 4
    t.integer  "purchased_list_id",  limit: 4
  end

  add_index "product_rows", ["checkout_list_id"], name: "index_product_rows_on_checkout_list_id", using: :btree
  add_index "product_rows", ["favourites_list_id"], name: "index_product_rows_on_favourites_list_id", using: :btree
  add_index "product_rows", ["product_id"], name: "fk_rails_cf1216850a", using: :btree
  add_index "product_rows", ["purchased_list_id"], name: "index_product_rows_on_purchased_list_id", using: :btree
  ...
  add_foreign_key "product_rows", "checkout_lists"
  add_foreign_key "product_rows", "favourites_lists"
  add_foreign_key "product_rows", "products"
  add_foreign_key "product_rows", "purchased_lists"
