...
ActiveRecord::Schema.define(version: 20170815043334) do
  ...
  add_index "mercado_pago_purchases", ["order_id"], name: "index_mercado_pago_purchases_on_order_id"
  ...
  create_table "order_products_rows", force: :cascade do |t|
    t.integer  "order_products_list_id"
  ...
  add_index "orders", ["order_products_list_id"], name: "index_orders_on_order_products_list_id"
